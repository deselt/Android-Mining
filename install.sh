...
GITHUB_RELEASE_JSON=$(curl --silent "https://api.github.com/repos/deselt/CCminer-ARM-optimized/releases?per_page=1" | jq -c '[.[] | del (.body)]')
...
wget https://raw.githubusercontent.com/deselt/Android-Mining/main/config.json -P ~/ccminer
